...
public abstract class IcomWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static IcomWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(IcomWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<IcomDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<IcomDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<IcomDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<IcomDbContext, Task<T>> func)
    {
        T result;
